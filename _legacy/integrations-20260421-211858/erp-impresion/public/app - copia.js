...
function calcPackaging() {
  ...
  return { rolls, hours, ...pricing, formulaText: "Tiempo = rollos / rendimiento. Costo = tiempo x operarios x costo hora.", explanation: "Empaque se mide por productividad del area, numero de operarios y cualquier costo externo asociado." };
}
