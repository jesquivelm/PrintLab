...
function renderIntegratedFlexoHtml() {
    ...
    // /calculo-flexografia is rendered from the integrated ERP app.
    // Do not wire new UI behavior to public/flexo-calculo.* expecting it to
    // affect this route; those legacy files are compatibility shims only.
    ...
    return raw
        .replace(/href="\/styles\.css"/g, 'href="/styles.css">\n  <link rel="stylesheet" href="/erp-impresion-assets/styles.css?v=plates-20260420d"')
        .replace(/src="\/app\.js"/g, 'src="/erp-impresion-assets/app.js?v=plates-20260420d"');
}
